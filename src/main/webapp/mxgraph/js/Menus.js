...
Menus = function(editorUi)
{
	...
	paramHandler.prototype.editorUi = editorUi;     //KRISHNA
...
Menus.prototype.init = function()
{
	...
	this.put('new', new Menu(mxUtils.bind(this, function(menu, parent)    //anjali
	{
		this.addMenuItems(menu, ['newService'], parent);
		menu.addSeparator(parent);
		this.addMenuItems(menu, ['template'], parent);
		
	})));	
	this.put('open', new Menu(mxUtils.bind(this, function(menu, parent)    //anjali
	{
		this.addMenuItems(menu, ['newOpen'], parent);
	...
	this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		...
		menu.addSeparator(parent);
		this.addMenuItems(menu, ['open','save', 'saveAs','saveAsTemplate', '-', 'export', 'import', 'editFile', '-', 'pageSetup', 'print','logout'], parent); //anjali
	})));
	this.put('edit', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['undo', 'redo','delete','selectAll']);
	})));
...
Menus.prototype.createPopupMenu = function(menu, cell, evt)
{
	...
	{
		this.addMenuItems(menu, ['delete','-', '-']);	  //anjali
	}
...
Menus.prototype.createMenubar = function(container)
{
	...
	var menus = ['file', 'edit', 'view', 'options', 'help'];
...
Menus.prototype.createButton = function(classname)
{
...
Menu.prototype.popupdialog = function () {      //KRISHNA
    return this;
};