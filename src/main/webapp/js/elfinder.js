 ...
 * @type String
 **/
elFinder.prototype.version = '2.1 (Nightly: 916091e)';
...
elFinder.prototype._options = {
	 ...
	 */
	commands : [
		'custom','replace','open', 'reload', 'home', 'up', 'back', 'forward', 'getfile', 'quicklook', 
		'download', 'rm', 'duplicate', 'rename', 'mkdir', 'mkfile', 'upload', 'copy', 
		'cut', 'paste', 'edit', 'extract', 'archive', 'search', 'info', 'view', 'help', 'resize', 'sort', 'netmount'
	],
	//@Harish Added custom(single file upload) and replace command tried as from net
	 ...
	 * @default "icons"
	 */
	//defaultView : 'icons', //@harish changed default view
	defaultView : 'list',
	...
	uiOptions : {
		...
		toolbar : [
			['back', 'forward'],
			//['netmount'],//@harish removed netmount
			// ['reload'],//@harish removed reload
			// ['home', 'up'],//@harish removed up
			['mkdir', 'upload','custom','replace'],//@harish removed mkfile and added custom and replace
			['open', 'getfile'],//@harish removed download
			['info'],
			['quicklook'],
			//['copy', 'cut', 'paste'], //@harish removed 
			//['rm'], //@harish removed
			//[ 'rename', 'edit', 'resize'], //@harish removed
			//['extract', 'archive'], //@harish removed
			//['search'], //@harish removed
			['view', 'sort'],
			//['help']//@harish removed
		],
	 ...
	 * @default  "auto"
	 */
	//height : 400,//@harish changed height size
	height : '500',
	...
	contextmenu : {
		// navbarfolder menu
		//navbar : ['open', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'info'],//@Harish removed remove,copy,cut,paste,duplicate options
		navbar : ['open', '|', 'info'],
		// current directory menu
		//cwd    : ['reload', 'back', '|', 'upload', 'mkdir', 'mkfile', 'paste', '|', 'sort', '|', 'info'], //@Harish removed upload,mkfile,paste options and added custom and replace
		cwd    : ['reload', 'back', '|', 'upload','custom','replace','mkdir',  '|', 'sort', '|', 'info'],
		// current directory file menu
		//files  : ['getfile', '|','open', 'quicklook', '|', 'download', '|', 'copy', 'cut', 'paste', 'duplicate', '|', 'rm', '|', 'edit', 'rename', 'resize', '|', 'archive', 'extract', '|', 'info'] //@Harish removed remove,rename,copy,cut,paste options and added custom and replace
		files  : ['getfile', '|','open', 'quicklook', '|', 'download','upload','replace', '|', 'edit', 'resize', '|', 'archive', 'extract', '|', 'info']
	},
...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.en = {
		...
		messages   : {
			...
			'errReplByChild'       : 'The folder $1 can not be replaced by an item it contains.',
			...
			/*'cmdupload'    : 'Upload files',*/ //@Harish Changed Text 
			'cmdupload'    : 'Zip File Upload',
			'cmdcustom'    : 'Single File Upload',//@vidya added for single file upload
			'cmdreplace'   : 'Replace File', //@Harish add for replace file
			'cmdview'      : 'View',
...
$.fn.elfinderuploadbutton = function(cmd) {
	return this.each(function() {
		var button = $(this).elfinderbutton(cmd)
			...
			input = $('<input type="file" multiple="false" accept="application/zip" />')//@harish changed to multiple false and zip only
				.change(function() {
					var _input = $(this);
					if (_input.val()) {
...
elFinder.prototype.commands.paste = function() {
	//@Harish Disabled the pase functionality
	/*
	this.updateOnSelect  = false;
...
//@vidya for single file upload
elFinder.prototype.commands.custom= function() 
{
	this.disableOnSearch = true;
	this.updateOnSelect  = false;
	this.shortcuts = [{	pattern     : 'ctrl+l'}];
	this.getstate = function() 
	{ 
		return 0; 
	};
	...
	{
		var fm=this.fm;		
		var content = $('<form method="post" action="connector" enctype="multipart/form-data"><input type="hidden" name="singleupload" value="singleupload"/><input type="hidden" name="target" value="'+fm.cwd().hash+'" /><input type="hidden" name="cmd" value="upload" /><table><tr><td>Expire Date</td><td><input type="text" name="expireDate" placeholder="DD-MM-YYYY" id="datepickersingle"/></td><td>Content Provider</td><td><input type="text" name="contentProvider" value="Default"/></td></tr><tr><td>Category Name</td><td><input type="text" name="categoryName" value="Default"/></td><td>Label Name</td><td><input type="text" name="labelName" value="Default"/></td></tr><tr><td>Language</td><td><input type="text" name="language" value="Default"/></td><td>Song Code</td><td><input type="text" name="songCode" value="Default"/></td></tr><tr><td>Song Name</td><td><input type="text" name="songName" value="Default"/></td><td>Country Name</td><td><input type="text" name="countryName" value="Default"/></td></tr><tr><td>Operator Name</td><td><input type="text" name="operatorName" value="Default"/></td><td>Download URL</td><td><input type="text" name="downloadUrl" value="Default"/></td></tr><tr><td>CRBT URL</td><td><input type="text" name="crbtUrl" value="Default"/></td><td>Billing URL</td><td><input type="text" name="billingUrl" value="Default"/></td></tr><tr><td>Options</td><td><input type="text" name="options" value="Default"/></td><td>File</td><td><input type="file" name="content"/></td></tr><tr><td colspan="2"><input type="submit" class="submitsingle" value="Upload File"/></td></tr></table></form>');
		fm.dialog(content, 
		{
		...
		$( "#datepickersingle").datepicker({ minDate: 0,dateFormat: 'dd-mm-yy'});
	};
};

//@Harish for Replace file
elFinder.prototype.commands.replace= function() 
{
	...
	{
		var fm=this.fm;		
		var content = $('<form method="post" action="connector" enctype="multipart/form-data"><input type="hidden" name="singleupload" value="replace"/><input type="hidden" name="target" value="'+fm.cwd().hash+'" /><input type="hidden" name="cmd" value="upload" /><table><tr><td><input type="file" name="content"/></td></tr><tr><td><center><input type="submit" class="submitsingle" value="Replace File"/></center></td></tr></table></form>');
		fm.dialog(content, 
		{
			title          : 'Replace',
			modal          : true,
...
elFinder.prototype.commands.rm = function() {
	...
	//@Harish Removed Shrotcut ctrl+backspace and delete
	/*this.shortcuts = [{
...
elFinder.prototype.commands.upload = function() {
	...
	this.exec = function(data) {
		...
		input = $('<input type="file" multiple="false" accept="application/zip" />')
			.change(function() {
