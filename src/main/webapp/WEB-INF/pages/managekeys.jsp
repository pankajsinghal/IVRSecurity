...
$(document).ready(function(){
	...
	newTextBoxDiv.after().html('<br><label>Long Code : </label>' +
	      '<input type="text" name="longcode[]" id="textbox' + counter + '">' + '<a href="javascript:removeElement('+counter+')" id="offerpeopleremove"></a>');
...
<script>
 ...
 { 
     ...
     var dataString = 'servicename='+ service_name + '&shortcode='+ short_code + '&calltype='+ call_type + long_code+'&Service='+service_type+'&page='+page;
