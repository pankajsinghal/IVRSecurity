								...
								<c:forEach items="${mxgraphversionlist}" var="userList" varStatus="theCount"> 
									...
									<tr class='tbl-item'>
										...
										<input type="hidden" name="hidden" id='${userList.mxgraph.id}' value="${userList.mxgraph.shortcode}">
										 ...
										 &nbsp;<span class="reset-btnkey"><a href="managekeys.htm?servicename=${userList.mxgraph.serviceName}&shortcode=${userList.mxgraph.shortcode}&calltype=OBD" rel='facebox'>Manage Key</a></span>
