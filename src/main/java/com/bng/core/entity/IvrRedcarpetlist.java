...
/**
 * IvrRedcarpetlist generated by hbm2java
 */
@Entity
@Table(name = "ivr_redcarpetlist")
public class IvrRedcarpetlist implements java.io.Serializable {
	...
	public IvrRedcarpetlist() {
	}

	public IvrRedcarpetlist(Date date, Integer isSeries, String msisdn) {
		this.date = date;
